# Test all e-commerce microservices (Product, User, Order) with PostgreSQL
# Prerequisites: PostgreSQL running (docker-compose up -d), all three services running
...
Write-Host "`n=== Testing Microservices (PostgreSQL) ===" -ForegroundColor Cyan
Write-Host "Product: $productUrl | User: $userUrl | Order: $orderUrl`n"
